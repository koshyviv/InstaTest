...
Driver.create([
      {username:"0",name:"Arjun",car:"SX4",lang:["English","Hindi","Kannada"]},
      {username:"1",name:"Bala",car:"SX4",lang:["Hindi","Kannada"]},
      {username:"2",name:"Shanker",car:"SX4",lang:["English","Kannada"]},
      {username:"3",name:"Vivek",car:"SX4",lang:["English","Hindi"]},
      {username:"4",name:"Prashant",car:"SX4",lang:["Kannada"]},
      {username:"5",name:"Divya",car:"SX4",lang:["Hindi","Kannada"]},
      {username:"6",name:"Prerna",car:"SX4",lang:["English"]},
      {username:"7",name:"Gowda",car:"SX4",lang:["Hindi","Kannada"]},
      {username:"8",name:"Naga",car:"SX4",lang:["Hindi","Kannada"]},
      {username:"9",name:"Shan",car:"SX4",lang:["Hindi","Kannada"]}
  ], (err, drivers) => {
    if(err){
        console.log("Error in seeding Drivers",err)
    }
    console.log(drivers);
